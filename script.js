/**
 * script.js  —  Minoli Fernando Portfolio
...
if (window.matchMedia('(pointer: fine)').matches) {
  ...
  document.querySelectorAll('a, button, .ftab, .proj-card').forEach(el => {
    el.addEventListener('mouseenter', () => {
      ...
      cursorRing.style.borderColor = 'rgba(217,70,239,0.6)';
    });
...
/* ─────────────────────────────────────────────────────────────
   2. CANVAS PARTICLE NETWORK — violet on dark
───────────────────────────────────────────────────────────── */
...
const MAX_DIST       = 120;
const COLOR          = '139,92,246'; /* violet primary */
...
const phrases = [
  'analyze --target business-requirements.srs',
  'running systems analysis check...',
  'export sprint-report --format PDF',
  'generate --type UML --diagram sequence',
  'review agile sprint backlog — ClickUp',
  'git commit -m "SRS document complete"',
];
